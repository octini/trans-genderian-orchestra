...
- **Design Patterns** - Identify and name specific patterns used (e.g., "Adapter", "Singleton", "Factory", "Strategy"). Detail the abstractions and interfaces.
...
- User overrides from ~/.config/opencode/trans-genderian-orchestra.json
...
- `trans-genderian-orchestra.json`: User configuration schema.
