...
function sharedStyles(): string {
  return `
      ...
      .brand-mark {
        ...
        background: linear-gradient(135deg, rgba(91, 206, 250, 0.22), rgba(245, 169, 184, 0.22), rgba(255, 255, 255, 0.12));
        color: #ffffff;
        font-weight: 700;
...
function brandImage(size: number): string {
  return `<div class="brand-mark" role="img" aria-label="trans-genderian-orchestra logo" style="width:${size}px;height:${size}px;font-size:${Math.max(18, Math.round(size * 0.2))}px">TGO</div>`;
}
