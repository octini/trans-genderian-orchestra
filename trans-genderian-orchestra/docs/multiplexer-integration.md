...
When OpenCode launches child agent sessions, trans-genderian-orchestra can open panes for those sessions automatically.
...
Edit `~/.config/opencode/trans-genderian-orchestra.json` (or `.jsonc`):
