...
| Band members | per-lens opt-in: cobain `opencode-go/muse-spark-1.3-contributor` (xhigh) / grohl `opencode-go/qwen3.8-flash` (high) / novoselic `opencode-go/deepseek-v4.1-flash` (max); unset lenses share `band-members` | `opencode-go/muse-spark-1.3-contributor` (xhigh, shared) | `opencode-go/muse-spark-1.3-contributor` (xhigh, shared) |
