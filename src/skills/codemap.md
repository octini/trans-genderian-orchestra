...
- This directory is partitioned by skill:
  ...
  - `src/skills/deepwork/` (Conductor-only workflow for heavy coding sessions)
  - `src/skills/trans-genderian-orchestra/` (Conductor-only plugin configuration and self-improvement guidance)
...
- `verify-release-artifact.ts` enforces artifact completeness by asserting key
  ...
  `src/skills/deepwork/SKILL.md`, plus `src/skills/trans-genderian-orchestra/SKILL.md`,
