...
const AGENT_GIFS: Record<string, string> = {
  ...
  builder: 'orchestrator.gif',
  input: 'input.gif',
  intro: 'intro.gif',
  orchestrator: 'orchestrator.gif',
  planner: 'orchestrator.gif',
  researcher: 'orchestrator.gif',
  reviewer: 'orchestrator.gif',
};
...
const DIVOOM_ENABLE_ENV = 'TRANS_GENDERIAN_ORCHESTRA_DIVOOM';
