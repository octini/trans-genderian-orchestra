 ...
 *
 * @param agentName - The agent name to normalize (e.g., "@reviewer" or "reviewer")
 * @returns The normalized agent name without @ prefix and trimmed of whitespace
 *
 * @example
 * normalizeAgentName("@reviewer") // returns "reviewer"
 * normalizeAgentName("  research  ") // returns "research"
 */
 ...
 *
 * @example
 * resolveAgentVariant(config, "@reviewer") // returns "high" if configured
 */
 ...
 *
 * Supports:
 * - internal names (e.g. "reviewer")
 * - @-prefixed names (e.g. "@reviewer")
 * - displayName aliases (e.g. "advisor" -> "reviewer")
 */
 ...
 * agent mentions (e.g. @reviewer) for runtime routing.
 */
 ...
 *
 * @example
 * applyAgentVariant("high", { agent: "reviewer" }) // returns { agent: "reviewer", variant: "high" }
 * applyAgentVariant("high", { agent: "reviewer", variant: "low" }) // returns original body with variant: "low"
 */
