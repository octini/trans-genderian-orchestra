...
**trans-genderian-orchestra** - A Dispatcher plugin for OpenCode, providing agent delegation, permission gating, and context orchestration. Built with TypeScript, Bun, and Biome.
...
```bash
git worktree add ../trans-genderian-orchestra-v2-<feature-name> \
...
# "plugin": ["file:///path/to/trans-genderian-orchestra"]
...
- 1050 tests passing — run `bun test` to verify
...
### Plugin
~/.local/share/opencode/trans-genderian-orchestra.<timestamp>.log
