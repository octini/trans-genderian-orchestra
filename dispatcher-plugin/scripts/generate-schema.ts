...
const outputPath = join(rootDir, 'trans-genderian-orchestra.schema.json');
...
const jsonSchema = {
  ...
  title: 'trans-genderian-orchestra',
  description:
    'Configuration schema for trans-genderian-orchestra plugin for OpenCode',
};
