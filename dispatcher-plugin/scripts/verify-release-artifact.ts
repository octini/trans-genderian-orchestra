...
const suspiciousPathPatterns = [
  /\/Users\/[^\s'"`]+(?:node_modules|trans-genderian-orchestra)[^\s'"`]*/,
  /\/home\/[^\s'"`]+(?:node_modules|trans-genderian-orchestra)[^\s'"`]*/,
];
...
const packagedRequiredFiles = [
  ...
  'src/skills/trans-genderian-orchestra/SKILL.md',
];
...
function verifyFreshInstall(tarballPath: string) {
  ...
  try {
    ...
    const smokeScript = [
      "import pkg from 'trans-genderian-orchestra';",
